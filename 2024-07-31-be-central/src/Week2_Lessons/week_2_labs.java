...
public class week_2_labs {
	...
	public static void main(String[] args) {
		...
		if (cookiesRemaining >= 5) {
			System.out.println("jackpot!!!");
		} else if (cookiesRemaining >= 2) {
			System.out.println(":D");
		} else if (cookiesRemaining > 0) {
		...
		case "SILVER":
			...
			System.out.println("Welcome, SILVER member! Your member discount is: " + loyaltyMemberDiscount);
			break;
		case "GOLD":
			loyaltyMemberDiscount = 0.15; 
			System.out.println("Welcome, GOLD member! Your member discount is: " +loyaltyMemberDiscount);
			break;
		case "PLATINUM":
			loyaltyMemberDiscount = 0.25;
			System.out.println("Welcome, PLATINUM member! Your member discount is: " +loyaltyMemberDiscount);
			break;
		default:
		...
		double billTotal = 400;
		double adjustedTotal = billTotal - (loyaltyMemberDiscount*billTotal);
		
		if (adjustedTotal > 500 && loyaltyMemberStatus == "SILVER") {
			String newLoyaltyMemberStatus = "GOLD";
			double newLoyaltyMemberDiscount = 0.15;
			double newAdjustedTotal = billTotal - (newLoyaltyMemberDiscount*billTotal);
			System.out.println("Congratulations! Your member discount has been upgraded to: " + newLoyaltyMemberStatus);
			System.out.println("Your new total is: " + newAdjustedTotal);
		} else if (adjustedTotal > 500 && loyaltyMemberStatus == "GOLD"){
			String newLoyaltyMemberStatus = "PLATINUM";
			double newLoyaltyMemberDiscount = 0.25;
			double newAdjustedTotal = billTotal - (newLoyaltyMemberDiscount*billTotal);
			System.out.println("Congratulations! Your member discount has been upgraded to: " + newLoyaltyMemberStatus);
			System.out.println("Your new total is: " + newAdjustedTotal);
		} else {
			System.out.println("Your member status is: " + loyaltyMemberStatus);
			System.out.println("Your member discount today is " + (billTotal - adjustedTotal));
			System.out.println("Your total payment is: " + adjustedTotal);
		}
